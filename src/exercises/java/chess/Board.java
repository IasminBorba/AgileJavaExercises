...
//        Piece.Type[] types = {Piece.Type.ROOK, Piece.Type.KNIGHT, Piece.Type.BISHOP, Piece.Type.QUEEN, KingPiece.Class, Piece.Type.BISHOP, Piece.Type.KNIGHT, Piece.Type.ROOK};
//
//
//
//        if (Objects.equals(color, Piece.Color.WHITE)) {
//            Piece piece = KingPiece.create(Piece.Color.WHITE);
